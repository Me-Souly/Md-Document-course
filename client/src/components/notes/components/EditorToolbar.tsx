  ...
  return (
    <div className={styles.toolbar}>
      ...
      <div className={styles.toolbarRight}>
        <button
          className={cn(styles.toolbarButton, previewMode === 'edit' && styles.toolbarButtonActive)}
        ...
        <button
          className={cn(styles.toolbarButton, previewMode === 'split' && styles.toolbarButtonActive)}
        ...
        <button
          className={cn(styles.toolbarButton, previewMode === 'preview' && styles.toolbarButtonActive)}
