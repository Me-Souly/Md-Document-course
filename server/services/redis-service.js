  ...
  async connect() {
    ...
    try {
      ...
      this.client.on('error', (err) => {
        ...
        if (!this.errorLogged) {
          console.warn('[Redis] ⚠ Redis connection failed. Application will work without cache.');
          console.warn('[Redis] To enable Redis: install and start Redis server, or set REDIS_ENABLED=false');
